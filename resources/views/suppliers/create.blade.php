...
@section('title', 'Add Supplier - Business Management System')
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Create a new supplier for your business</p>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul class="text-xs text-blue-700 space-y-1">
                    <li>Supplier ID will be generated automatically</li>
                    <li>Phone number is required for contact</li>
                    <li>Address information helps with delivery</li>
                    <li>Set status to active to enable ordering</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('form[action="{{ route('suppliers.store') }}"]');
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            // Show loading
            SweetAlertUtils.loading('Creating Supplier...');
            ...
            .then(data => {
                if (data.success) {
                    ...
                    SweetAlertUtils.createError('Supplier', data.message || 'Unknown error occurred');
                }
            })
            .catch(error => {
