    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('suppliers.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($suppliers as $supplier)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $supplier->supplier_id }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ number_format($supplier->total_purchases, 2) }}</td>
