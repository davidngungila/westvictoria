                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-gray-900">{{ is_object($product->brand) ? $product->brand->name : ($product->brand ?? 'Not specified') }}</p>
                            </div>
                            <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-gray-900">{{ is_object($product->supplier) ? $product->supplier->name : ($product->supplier ?? 'Not specified') }}</p>
                            </div>
                            <div>
