...
@section('title', 'Edit Product - Business Management System')
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update product information for {{ $product->name }}</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="cost_price" name="cost_price" value="{{ old('cost_price', $product->cost_price) }}" required step="0.01" min="0"
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="min_quantity" name="min_quantity" value="{{ old('min_quantity', $product->min_quantity) }}" min="0"
                            ...
                            <div>
                                ...
                                <select id="supplier" name="supplier"
                                    ...
                                    @foreach($suppliers as $supplier)
                                        <option value="{{ $supplier }}" {{ old('supplier', $product->supplier) == $supplier ? 'selected' : '' }}>{{ $supplier }}</option>
                                    @endforeach
                                </select>
                                @error('supplier')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        ...
        <div class="space-y-6">
                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col items-center">
                            @if($product->image)
                                ...
                                <button type="button" onclick="document.getElementById('image').click()" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm mb-2">
                                    Change Image
                                </button>
                            @else
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 class="text-sm font-medium text-blue-800 mb-2">Product Information</h3>
                <div class="text-xs text-blue-700 space-y-1">
                    ...
                    <p><strong>Stock Status:</strong> 
                        ...
                        @elseif($product->isLowStock())
                            <span class="text-orange-600 font-medium">Low Stock ({{ $product->quantity }})</span>
                        @else
                            <span class="text-green-600 font-medium">In Stock ({{ $product->quantity }})</span>
                        @endif
                    </p>
                </div>
            </div>
